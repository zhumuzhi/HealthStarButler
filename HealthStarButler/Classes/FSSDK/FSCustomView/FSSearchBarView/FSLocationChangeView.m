...
@interface FSLocationChangeView()
@property (nonatomic , strong) UIImageView *icon;
@property (nonatomic , strong) UILabel *location;
@property (nonatomic , strong) UIImageView *arrow;

@end
@implementation FSLocationChangeView
...
- (void)layoutSubviews {
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(locationChangeView:finalX:)]) {
        [self.delegate locationChangeView:self finalX:self.arrow.x];
    }
}
- (UIImageView *)arrow {
    if (_arrow == nil) {
        ...
        _arrow.image = [UIImage imageNamed:@"home_arrowDown"];
    }
    return _arrow;
}
- (UILabel *)location {
