...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        self.buttonStyle = FSCustomButtonImageTypeLeft;
...
- (CGRect)imageRectForContentRect:(CGRect)contentRect{
    if (self.buttonStyle == FSCustomButtonImageTypeRight) {
        return [self imageRectWithImageRightForContentTect:contentRect];
    }
    else if (self.buttonStyle == FSCustomButtonImageTypeTop){
        return [self imageRectWithImageTopForContentTect:contentRect];
    }
    else if (self.buttonStyle == FSCustomButtonImageTypeDown){
