...
-(void)setup {
    ...
    bg = [UIImage imageNamed:@"mzan"];
    bgPressed = [UIImage imageNamed:@"mzan"];
    
//    thumb = [UIImage imageNamed:@"circle_thumb"];
//    ridge = [UIImage imageNamed:@"circle_ridge"];
    
    percentLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 35, 55)];
    [percentLabel setFont:[UIFont fontWithName:@"Futura-CondensedMedium" size:12]];
    [percentLabel setTextColor:[UIColor colorWithRed:110/255.0 green:125/255.0 blue:210/255.0 alpha:1]];
    ...
    NSLog(@"%f--%f--%f---%f",self.bounds.origin.x
          ,self.bounds.origin.y,bg.size.width, bg.size.height);
    percentLayer = [KDGoalBarPercentLayer layer];
    percentLayer.contentsScale = [UIScreen mainScreen].scale;
    percentLayer.percent = 0;
    percentLayer.frame = CGRectMake(0, 0, 27, 27);
    NSLog(@"%f--%f--%f---%f",self.bounds.origin.x
    ...
    tappableRect = CGRectMake(150, 50, 127, 127);
}
