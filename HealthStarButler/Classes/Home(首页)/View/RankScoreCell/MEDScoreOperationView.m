...
-(instancetype)initWithFrame:(CGRect)frame
{
    if ( self == [super initWithFrame:frame]){
        ...
        UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(barPadding, barPadding/2, kScreenWidth-RBarPadding, 1)];
        ...
        CGFloat rankScoreBtnW = (kScreenWidth-2)/3;
        ...
        for (NSInteger i = 0; i<btnTitileArray.count; i++) {
            ...
            CGFloat rankScoreBtnX = ((kScreenWidth-2)/3+1) *i;
        ...
        for (int i=0; i<2; i++) {
            CGFloat btnGapLineX = (kScreenWidth-2)/3*(i+1)+i*0.5;
