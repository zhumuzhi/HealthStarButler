...
- (IBAction)authorization:(id)sender {
    if ([MEDHealthMananger TF_isHealthDataAvailable]) {
        [MEDHealthMananger TF_authorizeHealthKitWithType:self.quantityType
...
- (IBAction)readData:(id)sender {
    ...
    [MEDHealthMananger TF_getDayHealthWithType:self.quantityType queryResultBlock:^(NSArray *queryResults) {
...
//    [MEDHealthMananger TF_saveHealthKitDataType:self.quantityType startDate:startDate endDate:endDate number:num success:^(bool isSuccess, NSError *error) {
//        NSLog(@"%d" ,isSuccess);
//    }];
}
