...
#pragma mark - set方法
- (void)setDataModel:(MZDataModel *)dataModel {
...
#pragma mark - 懒加载
- (MZLoginButton *)sendCode {
    if (_sendCode == nil) {
        _sendCode = [[MZLoginButton alloc] init];
